...
# P4-1 阶段一: backend HTTP / data loaders / 工具函数全部集中在 streamlit_helpers
from streamlit_helpers import (  # noqa: F401
    ...
    _make_price_df_from_akshare,  # backward-compat alias
)

# 清理 proxy 环境变量(streamlit_helpers 加载时已做,这里冗余保护)
